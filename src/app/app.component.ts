...
import { ProfileFormComponent } from './user-profile-screen/profile-form/profile-form.component';
import { SignFormComponent } from './sign-up-screen/sign-form/sign-form.component';
...
export class AppComponent implements OnInit, AfterViewChecked{
  title = 'app';
  currentRoute: any='';
  constructor(private _formBuilder: FormBuilder,private route: ActivatedRoute,private router: Router,private service:HandleRequestsService){}
